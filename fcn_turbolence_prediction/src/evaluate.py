...
# Training utils
from training_utils import load_trained_model, get_model
from tfrecord_utils import get_dataset

#%% Configuration import
import config

#os.environ['MODEL_CNN'] = 'OuterRecon'
...
#CNN_model, _ = get_model(model_config)
...
print("Prediction 0:", np.count_nonzero(Y_pred[2]))
