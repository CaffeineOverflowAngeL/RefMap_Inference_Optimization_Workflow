...
class HybridGrowingRegPruner(HybridMetaPruner):
    ...
    def __init__(
        ...
        super(HybridGrowingRegPruner, self).__init__(
            model=model,
    ...
    def regularize(self, model, bias=False):
        for i, group in enumerate(self._groups):
            group_l2norm_sq = self.estimate_importance_regularize(group)
            if group_l2norm_sq is None:
                continue
